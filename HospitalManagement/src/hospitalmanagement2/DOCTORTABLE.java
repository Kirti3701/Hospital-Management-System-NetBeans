...
public class DOCTORTABLE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doctor_id", "Doctor_Name", "Designation", "Experience", "Joining_Date", "Department"
            }
        ) {
...
{    mongoClient = new MongoClient( "localhost" , 27017 );
    ...
    String[] columnNames = {"Doctor_id","Doctor_name","Designation","Experience", "Joining_Date", "Department"};
    ...
    while(cursor.hasNext()) {
        ...
        String joining_date= (String)obj.get("Joining_Date");
        ...
        model.addRow(new Object[] { did, dname, designation,experience,joining_date,department});
